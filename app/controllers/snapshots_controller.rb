class SnapshotsController < ApplicationController
  ...
  private
    ...
    def snapshot_params
      params.require(:snapshot).permit(:snapshotID, :interval, :firstSnapshot, :lastSnapshot, :snapshot1, :snapshot2, :snapshot3, :snapshot4, :snapshot5, :snapshot6, :snapshot7, :snapshot8, :snapshot9, :snapshot10)
    end
end
