class PlayerStatusesController < ApplicationController
  ...
  private
    ...
    def player_status_params
      params.require(:player_status).permit(:playerID, :timeStamp, :gameStatus, :gameConfigID, :gameLevel, :gameScore1, :gameScore2, :gameScore3, :gameScore4, :gameScore5, :gameScore6, :gameScore7, :gameScore8, :gameScore9, :gameScore10)
    end
end
