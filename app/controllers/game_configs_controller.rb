class GameConfigsController < ApplicationController
  ...
  private
    ...
    def game_config_params
      params.require(:game_config).permit(:gameConfigID, :gameID, :gameConfP1, :gameConfP2, :gameConfP3, :gameConfP4, :gameConfP5, :gameConfP6, :gameConfP7, :gameConfP8, :gameConfP9, :gameConfP10)
    end
end
